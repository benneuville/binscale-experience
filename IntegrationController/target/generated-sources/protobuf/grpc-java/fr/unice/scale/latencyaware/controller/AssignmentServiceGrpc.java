...
public final class AssignmentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<fr.unice.scale.latencyaware.controller.AssignmentRequest,
      fr.unice.scale.latencyaware.controller.AssignmentResponse> getGetAssignmentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAssignment",
      requestType = fr.unice.scale.latencyaware.controller.AssignmentRequest.class,
      responseType = fr.unice.scale.latencyaware.controller.AssignmentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<fr.unice.scale.latencyaware.controller.AssignmentRequest,
      fr.unice.scale.latencyaware.controller.AssignmentResponse> getGetAssignmentMethod() {
    io.grpc.MethodDescriptor<fr.unice.scale.latencyaware.controller.AssignmentRequest, fr.unice.scale.latencyaware.controller.AssignmentResponse> getGetAssignmentMethod;
      ...
      synchronized (AssignmentServiceGrpc.class) {
        if ((getGetAssignmentMethod = AssignmentServiceGrpc.getGetAssignmentMethod) == null) {
          AssignmentServiceGrpc.getGetAssignmentMethod = getGetAssignmentMethod =
              io.grpc.MethodDescriptor.<fr.unice.scale.latencyaware.controller.AssignmentRequest, fr.unice.scale.latencyaware.controller.AssignmentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getAssignment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fr.unice.scale.latencyaware.controller.AssignmentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fr.unice.scale.latencyaware.controller.AssignmentResponse.getDefaultInstance()))
  ...
  public static abstract class AssignmentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAssignment(fr.unice.scale.latencyaware.controller.AssignmentRequest request,
        io.grpc.stub.StreamObserver<fr.unice.scale.latencyaware.controller.AssignmentResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                fr.unice.scale.latencyaware.controller.AssignmentRequest,
                fr.unice.scale.latencyaware.controller.AssignmentResponse>(
  ...
  public static final class AssignmentServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AssignmentServiceBlockingStub> {
    ...
    /**
     */
    public fr.unice.scale.latencyaware.controller.AssignmentResponse getAssignment(fr.unice.scale.latencyaware.controller.AssignmentRequest request) {
  ...
  public static final class AssignmentServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AssignmentServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<fr.unice.scale.latencyaware.controller.AssignmentResponse> getAssignment(
        fr.unice.scale.latencyaware.controller.AssignmentRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ASSIGNMENT:
          serviceImpl.getAssignment((fr.unice.scale.latencyaware.controller.AssignmentRequest) request,
              (io.grpc.stub.StreamObserver<fr.unice.scale.latencyaware.controller.AssignmentResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AssignmentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return fr.unice.scale.latencyaware.controller.Assignment.getDescriptor();
    }
