package fr.unice.scale.latencyaware.consumer.assignment;
...
public class BinscalePartitionAssignor extends AbstractAssignor {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BinscalePartitionAssignor.class);
    ...
    public BinscalePartitionAssignor() {
    }
