...
public class CommonVariables {
    ...
    public static final String KAFKA_BOOTSTRAP_SERVERS = EnvUtils.envOrDefault("KAFKA_BOOTSTRAP_SERVERS", "my-cluster-kafka-bootstrap:9092");

    // Constants
    public static final String MESSAGE_COUNTER_NAME = "kafka_topic_input_counter";
