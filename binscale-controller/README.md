...
In it running sequence, the controller is 3 phases built : data collection, decision taking and scaling application.

*[Outdated version (data collection), sequentially valid]*
![controller_sequence_diagram.png](assets%2Fcontroller_sequence_diagram.png)\
